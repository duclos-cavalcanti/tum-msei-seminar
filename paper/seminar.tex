...
largely due to either improvements to existing architectures or novel ones alltogether. The process
...
consuming and an error-prone. This, among other reasons, has motivated the field of \textit{neural architecture search}
and the different methods of its application.
