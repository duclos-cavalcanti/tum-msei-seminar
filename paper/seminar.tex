...
to reduce size and memory consumption of deep learning models by the tinyML community. Therefore,
...
also vary. More on trade-offs and details to these approaches will be seen in section \ref{SOA}.
